...
const product_shared_1 = require("./services/product/product.shared");
const rating_shared_1 = require("./services/rating/rating.shared");
...
const createClient = (connection, authenticationOptions = {}) => {
    ...
    client.configure(rating_shared_1.ratingClient);
    client.configure(product_shared_1.productClient);
